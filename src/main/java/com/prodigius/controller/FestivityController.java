...
public class FestivityController {
        ...
        public Festivity create(@RequestBody Festivity festivity) throws Exception {
                ...
                if (Rule.areDatesValid(festivity.getStartDate(), festivity.getEndDate())) {
                        ...
                        throw new Exception(messageSource.getMessage("rest.rule.invalid.date", null,
        ...
        public Festivity getFestivity(@PathVariable Long id) {
                ...
                if (f == null) {
                        throw new NoResultException(messageSource.getMessage("rest.no.data.found", null,
                                        LocaleContextHolder.getLocale()));
                }
                return f;
        }
        ...
        @RequestMapping(value = "/festivity/filter/name", method = RequestMethod.GET, produces = {
                        MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE })
        @ResponseStatus(HttpStatus.OK)
        public List<Festivity> readByName(String name) {
                List<Festivity> f = fest.findByName(name);
                if (f == null) {
                        throw new NoResultException(messageSource.getMessage("rest.no.data.found", null,
                                        LocaleContextHolder.getLocale()));
                }
        ...
        @RequestMapping(value = "/festivity/filter/startDateRange", method = RequestMethod.GET, produces = {
                        MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE })
        @ResponseStatus(HttpStatus.OK)
        public List<Festivity> readByDateStarRange(@DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date startDateIni,
                ...
                List<Festivity> festList = fest.findByStartDateBetween(dateStartA.toDate(), dateStartB.toDate());
                if (festList == null) {
                        throw new NoResultException(messageSource.getMessage("rest.no.data.found", null,
                                        LocaleContextHolder.getLocale()));
                }
        ...
        @RequestMapping(value = "/festivity/filter/place", method = RequestMethod.GET, produces = {
                        MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE })
        @ResponseStatus(HttpStatus.OK)
        public List<Festivity> readByPlace(String place) {
                List<Festivity> f = fest.findByPlace(place);
                if (f == null) {
                        throw new NoResultException(messageSource.getMessage("rest.no.data.found", null,
                                        LocaleContextHolder.getLocale()));
                }
